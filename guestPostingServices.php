    ...
    <div class="main characteristics">
        ...
        <div class="characteristicsChart">
            <div class="characteristic">
                <img src="img/1.svg" alt="writers" class="imgCharacteristic">
            ...
            <div class="characteristic">
                <img src="img/2.svg" alt="writers" class="imgCharacteristic">
                <h3 class="titleCharacteristic">
            ...
            <div class="characteristic">
                <img src="img/3.svg" alt="writers" class="imgCharacteristic">
                <h3 class="titleCharacteristic">
                    Multiple Parameters
                </h3>
                <p class="descriptionCharacteristic">
            ...
            <div class="characteristic">
                <img src="img/4.svg" alt="writers" class="imgCharacteristic">
                <h3 class="titleCharacteristic">
                    Direct With Owners
                </h3>
                <p class="descriptionCharacteristic">
